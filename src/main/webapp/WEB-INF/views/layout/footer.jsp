...
<div class="footer-section">
    ...
    <span>상업적인 홈페이지가 아닌 포트폴리오/팀 프로젝트 페이지입니다.</span>
    <span class="footer-jaebok">Back-End : 이재복
    ...
    <span class="footer-sujin">Back-End : 김수진
    ...
    <span class="footer-jeseon">Front-End : 문제선
